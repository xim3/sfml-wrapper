...
EquipmentItem::EquipmentItem(sf::Texture &txt, std::string TEXT, int font_size, sf::Color font_color, sf::Vector2f box_size, sf::Color box_color, sf::Color outline_color, float thin_outline, sf::Font &font, uint8_t transparent)
{
...
bool EquipmentItem::click(sf::RenderWindow& window, sf::Event& event)
{
